...
public class ClubFunc {
    ...
    public void addClub(Club newClub) throws SQLException {
        ...
        String query = "INSERT INTO club VALUES" + "('" + newClub.getClub_id() + "', '" + newClub.getClub_name() +
    ...
    //join club
    public void joinClub(String studentID, String clubID){
        //create sqlConnection object
        SqlConnection sqlConnection = new SqlConnection();
        ...
        //MySQL query to insert data into database
        String query = "insert into student_club values ('" + studentID + "', '" + clubID + "';";
    ...
    public void deleteClub(String clubId){
        ...
        String deleteFromEventClub = "delete from event_club where club_id = '" + clubId + "';";
        String deleteFromAdvisorClub = "delete from club_advisor where club_id = '" + clubId + "';";
        String deleteFromStudentClub = "delete from student_club where club_id = '" + clubId + "';";
        String deleteFromClub = "delete from club where club_id = '" + clubId + "';";
    ...
    //generate unique identifier for club
    public String generateClubId() throws SQLException {
        SqlConnection sqlConnection = new SqlConnection();
        sqlConnection.startConnection();
        String getLatestId = "SELECT * FROM club ORDER BY club_id DESC LIMIT 1";
    ...
    public boolean isJoined(String studentID, String clubID) throws SQLException {
        //create sqlConnection object
        SqlConnection sqlConnection = new SqlConnection();
        ...
        //MySQL query to insert data into database
        String query = "select * from student_club where student_id = '" + studentID + "' and club_id = '" + clubID + "';";
